...
public class Produto {
	...
	//CONSTRUTOR IMPLICITO, NÃO NECESSITA DE PARÂMETRO
	Produto (){
		
	}

	//CONSTRUTOR EXPLICITO, TEM QUE ESCREVER NO PARÂMETRO A INFORMAÇÃO
	...
	/*OBS 1: O NOME DO METODO É O MESMO, O QUE ALTERA É A QUANTIDADE DE PARAMETROS
